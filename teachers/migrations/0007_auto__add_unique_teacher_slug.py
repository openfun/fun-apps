...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Teacher', fields ['slug']
        db.create_unique('teachers_teacher', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Teacher', fields ['slug']
        db.delete_unique('teachers_teacher', ['slug'])
