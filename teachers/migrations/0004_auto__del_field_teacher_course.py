...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Teacher.course'
        db.delete_column('teachers_teacher', 'course_id')


    def backwards(self, orm):
        # Adding field 'Teacher.course'
        db.add_column('teachers_teacher', 'course',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='teachers', to=orm['courses.Course']),
                      keep_default=False)
