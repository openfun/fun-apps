...
from fun_instructor.tasks import answers_distribution_report_generation_task_class, generate_verified_certificate_task_class
...
def submit_generate_verified_certificate(request, course_key, query_features):
    """ Request to generate certificate as a background task. """
