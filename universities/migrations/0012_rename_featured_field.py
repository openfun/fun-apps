...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('universities_university', 'featured', 'detail_page_enabled')


    def backwards(self, orm):
        db.rename_column('universities_university', 'detail_page_enabled', 'featured')
    ...
    models = {
        'universities.university': {
            ...
            'detail_page_enabled': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
