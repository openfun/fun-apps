...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'University.parent'
        db.add_column('universities_university', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='children', null=True, to=orm['universities.University']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'University.parent'
        db.delete_column('universities_university', 'parent_id')
