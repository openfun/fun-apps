...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'University', fields ['is_obsolete']
        db.create_index('universities_university', ['is_obsolete'])


    def backwards(self, orm):
        # Removing index on 'University', fields ['is_obsolete']
        db.delete_index('universities_university', ['is_obsolete'])
