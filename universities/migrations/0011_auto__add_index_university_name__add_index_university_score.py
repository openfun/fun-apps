...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'University', fields ['name']
        db.create_index('universities_university', ['name'])

        # Adding index on 'University', fields ['score']
        db.create_index('universities_university', ['score'])


    def backwards(self, orm):
        # Removing index on 'University', fields ['score']
        db.delete_index('universities_university', ['score'])

        # Removing index on 'University', fields ['name']
        db.delete_index('universities_university', ['name'])
