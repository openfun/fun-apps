...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'University.prevent_auto_update'
        db.add_column('universities_university', 'prevent_auto_update',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'University.prevent_auto_update'
        db.delete_column('universities_university', 'prevent_auto_update')
