...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'University.short_name'
        db.add_column('universities_university', 'short_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'University.short_name'
        db.delete_column('universities_university', 'short_name')
