...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'University', fields ['detail_page_enabled']
        db.create_index('universities_university', ['detail_page_enabled'])


    def backwards(self, orm):
        # Removing index on 'University', fields ['detail_page_enabled']
        db.delete_index('universities_university', ['detail_page_enabled'])
