...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'University.is_obsolete'
        db.add_column('universities_university', 'is_obsolete',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'University.is_obsolete'
        db.delete_column('universities_university', 'is_obsolete')
