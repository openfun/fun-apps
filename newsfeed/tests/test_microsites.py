...
from backoffice.tests.test_microsites import BaseMicrositeTestCase, FAKE_MICROSITE1, FAKE_MICROSITE2
...
class TestNews(ModuleStoreTestCase):
    def setUp(self):
        ...
        news2 = Article.objects.create(title=u"Microsite 2", slug='microsite2',
