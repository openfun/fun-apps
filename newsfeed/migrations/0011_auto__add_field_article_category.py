...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('newsfeed_article', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='articles', null=True, to=orm['newsfeed.ArticleCategory']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.category'
        db.delete_column('newsfeed_article', 'category_id')
