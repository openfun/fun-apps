...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ArticleCategory', fields ['slug']
        db.create_unique('newsfeed_articlecategory', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'ArticleCategory', fields ['slug']
        db.delete_unique('newsfeed_articlecategory', ['slug'])
