...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.microsite'
        db.add_column('newsfeed_article', 'microsite',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=128, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.microsite'
        db.delete_column('newsfeed_article', 'microsite')
