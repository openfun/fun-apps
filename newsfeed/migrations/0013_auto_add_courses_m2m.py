...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field courses on 'Article'
        m2m_table_name = db.shorten_name('newsfeed_article_courses')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('article', models.ForeignKey(orm['newsfeed.article'], null=False)),
            ('course', models.ForeignKey(orm['courses.course'], null=False))
        ))
        db.create_unique(m2m_table_name, ['article_id', 'course_id'])


    def backwards(self, orm):
        # Removing M2M table for field courses on 'Article'
        db.delete_table(db.shorten_name('newsfeed_article_courses'))
