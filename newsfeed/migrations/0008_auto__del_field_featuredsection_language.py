...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FeaturedSection.language'
        db.delete_column('newsfeed_featuredsection', 'language')


    def backwards(self, orm):
        # Adding field 'FeaturedSection.language'
        db.add_column('newsfeed_featuredsection', 'language',
                      self.gf('django.db.models.fields.CharField')(default='fr', max_length=8),
                      keep_default=False)
