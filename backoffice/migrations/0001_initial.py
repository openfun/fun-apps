...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Course'
        db.create_table('backoffice_course', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('key', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('organisation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['universities.University'], null=True)),
        ))
        db.send_create_signal('backoffice', ['Course'])

        # Adding model 'Teacher'
        db.create_table('backoffice_teacher', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['backoffice.Course'])),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('backoffice_course')

        # Deleting model 'Teacher'
        db.delete_table('backoffice_teacher')
    ...
    models = {
        'backoffice.course': {
            ...
            'organisation': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['universities.University']", 'null': 'True'})
        },
        'backoffice.teacher': {
