# This is FUN's tinymce configuration for html xmodule
# We allow writing from right to left
# This file is used as a replacement for edx-platform/common/lib/xmodule/xmodule/js/src/html/edit.coffee
# The replacement itself is done by modifying PIPELINE_JS constant in our settings
...
#http://localhost:7001/static/plugins/js/vendor/tinymce/js/tinymce/textcolor/plugin.min.js
#http://localhost:7001/static//js/vendor/tinymce/js/tinymce/plugins/directionality/plugin.min.js
#http://localhost:7001/static//plugins/js/vendor/tinymce/js/tinymce/plugins/link/plugin.min.js
  ...
  #   tinyMCE incorrectly decides that the suffix should be "", which means it fails to load files.
      ...
      @tiny_mce_textarea = $(".tiny-mce", @element).tinymce({
        ...
        visual: false,
        #plugins: "js/vendor/tinymce/js/tinymce/plugins/textcolor, js/vendor/tinymce/js/tinymce/plugins/link, js/vendor/tinymce/js/tinymce/plugins/image, js/vendor/tinymce/js/tinymce/plugins/codemirror, js/vendor/tinymce/js/tinymce/plugins/directionality",
