...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseSubject.score'
        db.add_column('courses_coursesubject', 'score',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseSubject.score'
        db.delete_column('courses_coursesubject', 'score')
