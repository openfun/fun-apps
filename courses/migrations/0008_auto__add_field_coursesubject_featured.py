...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseSubject.featured'
        db.add_column('courses_coursesubject', 'featured',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseSubject.featured'
        db.delete_column('courses_coursesubject', 'featured')
