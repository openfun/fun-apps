...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('courses_course', 'language',
                      self.gf('django.db.models.fields.CharField')(default='fr', max_length=255, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.language'
        db.delete_column('courses_course', 'language')
