...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.session_number'
        db.add_column('courses_course', 'session_number',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.session_number'
        db.delete_column('courses_course', 'session_number')
