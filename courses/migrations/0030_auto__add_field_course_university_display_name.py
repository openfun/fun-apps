...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.university_display_name'
        db.add_column('courses_course', 'university_display_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.university_display_name'
        db.delete_column('courses_course', 'university_display_name')
