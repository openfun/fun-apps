...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.show_in_catalog'
        db.add_column('courses_course', 'show_in_catalog',
                      self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.show_in_catalog'
        db.delete_column('courses_course', 'show_in_catalog')
