...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.enrollment_start_date'
        db.add_column('courses_course', 'enrollment_start_date',
                      self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.enrollment_start_date'
        db.delete_column('courses_course', 'enrollment_start_date')
