...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('courses_course', 'university_id')


    def backwards(self, orm):
        # Adding field 'Course.university'
        db.add_column('courses_course', 'university',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['universities.University'], blank=True),
                      keep_default=False)
