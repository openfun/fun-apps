...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.thumbnails_info'
        db.add_column('courses_course', 'thumbnails_info',
                      self.gf('jsonfield.fields.JSONField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.thumbnails_info'
        db.delete_column('courses_course', 'thumbnails_info')
