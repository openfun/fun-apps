...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.prevent_auto_update'
        db.add_column('courses_course', 'prevent_auto_update',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.prevent_auto_update'
        db.delete_column('courses_course', 'prevent_auto_update')
