...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CourseSubject.order'
        db.delete_column('courses_coursesubject', 'order')


    def backwards(self, orm):
        # Adding field 'CourseSubject.order'
        db.add_column('courses_coursesubject', 'order',
    ...
    models = {
        ...
        'courses.coursesubject': {
            'Meta': {'ordering': "('-score', 'id')", 'object_name': 'CourseSubject'},
