...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'CourseUniversityRelation', fields ['order']
        db.create_index('courses_courseuniversityrelation', ['order'])

        # Adding index on 'CourseSubject', fields ['score']
        db.create_index('courses_coursesubject', ['score'])

        # Adding index on 'CourseSubject', fields ['name']
        db.create_index('courses_coursesubject', ['name'])

        # Adding index on 'Course', fields ['score']
        db.create_index('courses_course', ['score'])


    def backwards(self, orm):
        # Removing index on 'Course', fields ['score']
        db.delete_index('courses_course', ['score'])

        # Removing index on 'CourseSubject', fields ['name']
        db.delete_index('courses_coursesubject', ['name'])

        # Removing index on 'CourseSubject', fields ['score']
        db.delete_index('courses_coursesubject', ['score'])

        # Removing index on 'CourseUniversityRelation', fields ['order']
        db.delete_index('courses_courseuniversityrelation', ['order'])
