...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.modification_date'
        db.add_column('courses_course', 'modification_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2015, 9, 16, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.modification_date'
        db.delete_column('courses_course', 'modification_date')
