...
def dashboard(request, course_id):
    ...
    answers_distribution_reports = utils.get_answers_distribution_reports_from_course(course_key)
    running_reports_generation = get_running_instructor_tasks(course_key,
...
def download(request, course_id, answers_distribution_report):
    ...
    response['Content-Disposition'] = 'attachment; filename="{}"'.format(
        utils.remove_accents(answers_distribution_report))
