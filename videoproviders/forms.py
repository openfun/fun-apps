...
class SubtitleForm(VideoForm):
    ...
    SUPPORTED_LANGUAGES = [lang for lang in global_settings.LANGUAGES if len(lang[0]) == 2]
    ...
    language = forms.ChoiceField(label=_("Subtitle language"), choices=SUPPORTED_LANGUAGES)
